...
const CK_A_Y = RET_Y - 102;
const CK_3_Y = RET_Y - 50;
const CK_6_Y = RET_Y + 60;
const CK_B_Y = RET_Y + 112;
...
> = {
  ...
  "C-5": { x: (LX + RX) / 2, y: RET_Y, tagY: -16 },
  "C-6": { x: LX, y: CK_6_Y, rot: 90, tagX: 22, tagY: 4 },
  "C-7": { x: RX, y: CK_6_Y, rot: 90, tagX: 22, tagY: 4 },
  ...
  "S-1": { x: 230, y: SP_Y, tagY: 28 },
  "S-2": { x: 350, y: SP_Y, tagY: 28 },
  "S-3": { x: 422, y: SP_Y, tagY: -18 },
  "S-4": { x: KILL_X, y: HANG_Y, rot: 90, tagX: -24, tagY: 4 },
  "S-5": { x: 250, y: HANG_Y, rot: 90, tagX: 22, tagY: 4 },
  "S-6": { x: 360, y: HANG_Y, rot: 90, tagX: 22, tagY: 4 },
  "S-7": { x: 500, y: SP_Y, tagY: -18 },
  ...
  "T-1": { x: 538, y: TT_Y, size: "fill", tagY: 28 },
...
export function Schematic() {
  ...
  return (
    <g className="select-none" onClick={() => select(null)}>
      ...
      <Skid x={96} y={50} w={400} h={80} title="*Rig Pumps" />
      <Skid x={86} y={145} w={400} h={155} title="*Rig Stand Pipe MN" />
      <Skid x={250} y={410} w={380} h={150} title="*Trip Tank" />
      <Skid x={FL_X - 70} y={40} w={260} h={380} title="*Rig Flow Line" />
      <Skid x={LX - 90} y={CK_A_Y - 50} w={360} h={CK_B_Y - CK_A_Y + 100} title="DUAL CHOKE" hatch />
      ...
      <Pipe d={`M ${KILL_X} ${SP_Y} L 212 ${SP_Y}`} live={hdrLeft} />
      <Tee x={KILL_X} y={SP_Y} />
      <Pipe d={`M 248 ${SP_Y} L 332 ${SP_Y}`} live={hdrMid} />
      <Pipe d={`M 368 ${SP_Y} L 404 ${SP_Y}`} live={hdrMid || (v("S-3") && t3On)} />
      <Pipe d={`M 440 ${SP_Y} L 482 ${SP_Y}`} live={t3On || (v("S-3") && hdrRight)} />
      <Pipe d={`M 518 ${SP_Y} L ${FL_X} ${SP_Y}`} live={sppLive} />
      <Tee x={FL_X} y={SP_Y} />
      <ArrowFlag x={548} y={SP_Y} label="SPP Bleed Off" />
      ...
      <Pipe d={`M 250 ${SP_Y} L 250 ${HANG_Y - 18}`} live={false} />
      <Pipe d={`M 250 ${HANG_Y + 18} L 250 ${HANG_Y + 36}`} live={false} />

      <Pipe d={`M 360 ${SP_Y} L 360 ${HANG_Y - 18}`} live={hdrMid} />
      <Pipe d={`M 360 ${HANG_Y + 18} L ${DRILL_X} ${HANG_Y + 18} L ${DRILL_X} ${RCD_TOP}`} live={dsLive} />
      <ArrowFlag x={380} y={HANG_Y + 18} label="Drill String" />
      <Tee x={360} y={SP_Y} />
      ...
      <Pipe d={`M ${FL_X} ${F5_Y} L ${FL_X} ${F3_Y}`} live={toFlLive || c2Live} />
      <Pipe d={`M ${FL_X} ${F3_Y} L ${FL_X} ${F4_Y}`} live={flLive || toFlLive || c2Live} />
      <Pipe d={`M ${FL_X} ${F4_Y} L ${FL_X} 146`} live={flLive || toFlLive || c2Live} />
      ...
      <Pipe d={`M ${MGS_X + 48} ${F3_Y} L ${FL_X + 76} ${F3_Y}`} live={flLive && v("F-3")} />
      <Tee x={FL_X} y={F3_Y} />
      ...
      <Pipe d={`M 500 ${TT_Y} L 520 ${TT_Y}`} live={false} size="fill" />
      <Pipe d={`M 556 ${TT_Y} L ${FL_X} ${TT_Y}`} live={v("T-1")} size="fill" />
      <Tee x={FL_X} y={TT_Y} size="fill" />
      <Pipe d={`M ${FILL_X + 18} ${TT_Y} L 390 ${TT_Y}`} live={false} size="fill" />
      ...
      <Pipe d={`M ${LX + 11} ${RET_Y} L ${(LX + RX) / 2 - 18} ${RET_Y}`} live={v("C-5") && primLive} />
      <Pipe d={`M ${(LX + RX) / 2 + 18} ${RET_Y} L ${RX - 11} ${RET_Y}`} live={v("C-5") && primLive} />
      ...
      <Pipe d={`M ${LX} ${RET_Y + 11} L ${LX} ${CK_6_Y - 18}`} live={bLive} />
      <Pipe d={`M ${LX} ${CK_6_Y + 18} L ${LX} ${CK_B_Y}`} live={bLive} />
      <Pipe d={`M ${LX} ${CK_B_Y} L ${RX} ${CK_B_Y} L ${RX} ${CK_6_Y + 18}`} live={bLive} />
      <Pipe d={`M ${RX} ${CK_6_Y - 18} L ${RX} ${RET_Y + 11}`} live={bLive} />
      <Tee x={LX} y={CK_B_Y} />
      <Tee x={RX} y={CK_B_Y} />
      ...
      <Pipe
        d={`M ${d6 + 18} ${RET_Y} L ${MGS_X - 70} ${RET_Y} L ${MGS_X - 70} ${F3_Y} L ${MGS_X - 48} ${F3_Y}`}
        live={mgsLive}
      />
      ...
      />
      <SppRead x={540} y={72} live={pumpsLive} />
