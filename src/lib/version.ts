...
export const CHANGELOG: ChangeEntry[] = [
  {
    version: "1.4.3.0",
    date: "2026-09-16",
    title: "C-8 lower equalize",
    notes: [
      "C-8 is lower-center equalize (peer to C-5). Default closed. Open C-5 or C-8 = choke bypass.",
      "Ck-B service is C-1 ∧ C-6 ∧ C-7 only. Cate owns equalize tag geometry on the sheet.",
    ],
  },
  {
    version: "1.4.2.0",
